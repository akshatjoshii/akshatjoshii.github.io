...
/***** akshatjs function start *****/
var akshatjs = function() {
	/*SmoothScroll start*/
	smoothScroll.init({
		speed: 800,
	...
	/*Typed js start*/
	$("#typed").typed({
		strings: ["^2100&nbsp;I Am Akshat.<br/>Javascript / Full Stack Developer.<br/> Living in New Delhi."],
		typeSpeed: 30,
		backDelay: 750,
		loop: false,
		cursorChar: "|",
...
$(document).on("ready",function() {
	/*akshatjs function init start*/
	akshatjs();
	/*akshatjs function init end*/
